                     ...
                     <div align="center">
						...
						<c:forEach var="vo" items="${list}" varStatus="status">
							<div class="card" style="width: 18rem;">
							  ...
							  <div class="card-body">
							    <input type="button" value="객실정보 확인하기" onclick="document.location.href='/pro/res/motelroominfo?m_region1_idx=${vo.m_region1_idx}&m_region2_idx=${vo.m_region2_idx }&motel_idx=${vo.motel_idx }&m_room_idx=${vo.m_room_idx }'">
							  </div>
							</div>
						</c:forEach>
						</c:otherwise>
