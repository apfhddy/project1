                ...
                <div class="semi">
					<div align="center">
						<c:forEach var="vo" items="${list }">
							<form action="/pro/res/resulthotel" method="post">						
							<input type="hidden" name="h_region1_idx" value="${list.get(0).h_region1_idx }">
							<input type="hidden" name="h_region2_idx" value="${list.get(0).h_region2_idx }">
							<input type="hidden" name="hotel_idx" value="${list.get(0).hotel_idx }">
							<input type="hidden" name="h_room_idx" value="${list.get(0).h_room_idx }">
							...
							<input type="hidden" name="h_coupon_idx" value="${h_coupon_idx }">
